...
2. Functions evaluation could not have any side-effects. You might ask what side-effects? &#x1F914; functions.. side-effects? *Side-effects* is just jargon for the fact that your functions should not make any changes to the things that outside of its scope, e.g. changing a mutable state, performing I/O and calling other functions that have side effects.
...
&#x26A0; **The code here is written in [Haskell][haskell], but the concepts are language agnostic. Different languages choose and implement these concepts differently.**
