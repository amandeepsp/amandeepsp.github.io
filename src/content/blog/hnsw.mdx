...
import SvgFigure from "@/components/SvgFigure.astro";
...
<SvgFigure
  ...
  caption="Voronoi diagram: each colored region contains all points closest to its center"
  width="75%"
/>
...
<SvgFigure
  ...
  caption="Delaunay triangulation graph where nodes represent points and edges connect adjacent Voronoi cells"
  width="75%"
/>
...
<SvgFigure
  ...
  caption="Delaunay Walk: starting from an arbitrary point, we greedily move to closer neighbors until reaching the nearest neighbor of q"
  width="75%"
/>
