...
A major takeaway from the first 3 chapters is a style of programming called functional programming.
<!--more-->

Functional Programming preaches the idea that your functions should be pure, i.e. they should follow two simple rules. 
