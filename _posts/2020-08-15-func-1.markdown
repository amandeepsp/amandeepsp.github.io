...
A major takeaway from the first 3 chapters is a style of programming called functional programming. **Functional Programming** basically distils down to the fact that your functions should be pure, i.e. they could not have any side-effects. You might ask what side-effects? :thinking: functions.. side-effects?
